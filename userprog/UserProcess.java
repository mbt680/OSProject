...
public class UserProcess {
	...
	public UserProcess() {
		...
		fileSystem = new FileWraper[256];

		for (int i = 0; i < 256; ++i)
			fileSystem[i] = new FileWraper();
	 ...
	 * 
	 */
	private class FileWraper {
		public FileWraper() {

		}

		public FileWraper(String s, OpenFile f, int i) {
			name = s;
			file = f;
			location = i;
			delete = false;
